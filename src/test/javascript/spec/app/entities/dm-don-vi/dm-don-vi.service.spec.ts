...
describe('Service Tests', () => {
    describe('DmDonVi Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new DmDonVi('ID', 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a DmDonVi', async () => {
            ...
            it('should update a DmDonVi', async () => {
                const returnedFromService = Object.assign(
                    {
                        ma: 'BBBBBB',
                        ten: 'BBBBBB'
            ...
            it('should return a list of DmDonVi', async () => {
                const returnedFromService = Object.assign(
                    {
                        ma: 'BBBBBB',
                        ten: 'BBBBBB'
            ...
            it('should delete a DmDonVi', async () => {
